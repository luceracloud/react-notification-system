...
/***/ (function(module, exports, __webpack_require__) {
	...
	var NotificationContainer = __webpack_require__(16);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createReactClass = __webpack_require__(3);
	var PropTypes = __webpack_require__(11);
	var NotificationItem = __webpack_require__(17);
	var Constants = __webpack_require__(19);
	    ...
	    function render() {
	      ...
	      if (notification.dismissible === 'both' || notification.dismissible === 'button' || notification.dismissible === true) {
	        dismiss = React.createElement(
	          'span',
	          { className: 'notification-dismiss', onClick: this._dismiss, style: this._styles.dismiss },
	          '\xD7'
	        );
	      }
	      ...
	      return React.createElement(
	        'div',
	        { className: className, onClick: this._handleNotificationClick, onMouseEnter: this._handleMouseEnter, onMouseLeave: this._handleMouseLeave, style: notificationStyle },
	        title,
	        message,
	        dismiss,
	        actionButton
